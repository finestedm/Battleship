                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="input-group">
                            ...
                            <input type='text' id='new-player-name' class="form-control" aria-label="Player name"></input>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" id='btn-name-save' class="btn btn-primary">Save changes</button>
                    </div>
                </div>
            </div>
        </div>`
